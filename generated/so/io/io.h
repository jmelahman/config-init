...
typedef struct io_Reader {
    void* self;
    so_R_int_err (*Read)(void* self, so_Slice);
} io_Reader;
...
typedef struct io_Writer {
    void* self;
    so_R_int_err (*Write)(void* self, so_Slice);
} io_Writer;
...
typedef struct io_Seeker {
    void* self;
    so_R_i64_err (*Seek)(void* self, int64_t, so_int);
} io_Seeker;
...
typedef struct io_ReaderFrom {
    void* self;
    so_R_i64_err (*ReadFrom)(void* self, io_Reader);
} io_ReaderFrom;
...
typedef struct io_WriterTo {
    void* self;
    so_R_i64_err (*WriteTo)(void* self, io_Writer);
} io_WriterTo;
...
typedef struct io_ReaderAt {
    void* self;
    so_R_int_err (*ReadAt)(void* self, so_Slice, int64_t);
} io_ReaderAt;
...
typedef struct io_WriterAt {
    void* self;
    so_R_int_err (*WriteAt)(void* self, so_Slice, int64_t);
} io_WriterAt;
...
typedef struct io_ByteWriter {
    void* self;
    so_Error (*WriteByte)(void* self, so_byte);
} io_ByteWriter;
...
typedef struct io_StringWriter {
    void* self;
    so_R_int_err (*WriteString)(void* self, so_String);
} io_StringWriter;
